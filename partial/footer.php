 <div class="text-white footer-background">
     ...
     <div class="container">
         <p class=" mx-5 p-2">Astrotalk is the best astrology website for online Astrology predictions. Talk to
             Astrologer on call and get answers to all your worries by seeing the future life through Astrology
             Kundli Predictions from the best Astrologers from India. Get best future predictions related to
             Marriage, love life, Career or Health over call, chat, query or report.</p>
         <hr>

         <div class="col-md-12 pt-4 container">
             <div class="row">
                 <div class=" col-md-3">
                 ...
                 <div class=" col-md-3">
                     ...
                     <ul class="list-unstyled">
                         ...
                         <ul class="list-unstyled">
                             ...
                             <a style="color: #3b5998; font-size:30px;" href="#!" role="button">
                                 <i class="bi bi-linkedin mx-2"></i></a>

                             <a style="color: #55acee; font-size:30px;" href="#!" role="button">
                                 <i class="bi bi-facebook mx-2"></i></a>

                             <a style="color: #ac2bac; font-size:30px;" href="#!" role="button">
 ...
 <div class="justify-content-evenly bg-dark text-white">
     <div class="text-center">
         <p> Thank you for visiting our website.</p>
         <p>© First Homebuy Realty. ALL RIGHTS RESERVED <?php echo date('Y');?></p>
     </div>
